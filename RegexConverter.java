...
public class RegexConverter implements RegexConstant{
	...
	private Integer getPrecedencia(Character c) {
        ...
        {   
            for (int i = 0; i<regex.length();i++){
                ...
                if (ch.equals(charInt))
                {
                    ...
                    {
                        regex = insertCharAt(regex,i,charOr+""+EPSILON+charCerrarParentesis);
         ...
         */
        private boolean balancearParentesis(String regex){
                    ...
                    if (regex.charAt(i+2)=='-'){
                        ...
                        for (int j = 0;j<=fin-inicio;j++)
                        {
                            ...
                            if (j==(fin-inicio))
                             ...
                             resultado+= pos+ Character.toString((char)(inicio+j))+charOr;
