...
public class ParserSLR {
    ...
    private final ArrayList<TablaParseo> tablaParseo;
    private Sintaxis syntax;
    private Automata LR;
    private String nombreArchivo;
    private ArrayList globalClosure = new ArrayList();

    public ParserSLR(ArrayList<Produccion> producciones,Sintaxis syntax,String nombreArchivo) {
    ...
    public boolean terminal(String simbolo){
     ...
     public ArrayList<TablaParseo> reducciones(Estado SLR){
         ArrayList<TablaParseo> itemsNuevos = new ArrayList();
                ...
                if ((int)product.getItem().getPosicion() == product.getCuerpo().split(" ").length
                    ...
                    if (indiceBuscado != -1){
                        ...
                        for (String letra2: (HashSet<String>)resultadoFollow){
                            if (!letra2.isEmpty())
                                tablaParseo.add(new TablaParseo(i,letra2,"r",indiceBuscado));
                        }
